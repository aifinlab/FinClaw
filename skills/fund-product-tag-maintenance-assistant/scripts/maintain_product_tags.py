...
TASK_NAME = "产品标签维护助手"
TASK_SUMMARY = "对基金产品标签进行梳理、维护和更新说明，保证标签体系与产品事实和内部口径一致。"
REQUIRED_INPUTS = json.loads("[\"产品基础资料\",\"策略和持仓特征\",\"现有标签体系\",\"渠道或系统字段要求\"]")
OUTPUT_SECTIONS = json.loads("[\"建议标签清单\",\"标签依据\",\"冲突与注意事项\",\"更新记录\",\"待人工确认项\"]")
