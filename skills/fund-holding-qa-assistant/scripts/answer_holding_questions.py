...
TASK_NAME = "持仓问答助手"
TASK_SUMMARY = "围绕客户持有基金或组合的表现、回撤、结构变化和后续关注点生成可复用问答。"
REQUIRED_INPUTS = json.loads("[\"持仓产品与持有周期\",\"收益、回撤和波动信息\",\"近期市场或产品事件\",\"客户主要问题\"]")
OUTPUT_SECTIONS = json.loads("[\"问答清单\",\"关键解释逻辑\",\"风险与边界提醒\",\"后续关注建议\",\"待补材料\"]")
