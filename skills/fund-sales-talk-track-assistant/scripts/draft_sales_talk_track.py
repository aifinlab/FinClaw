...
TASK_NAME = "销售话术助手"
TASK_SUMMARY = "根据产品卖点、客群特征和合规边界生成基金销售话术草稿与异议应答。"
REQUIRED_INPUTS = json.loads("[\"产品事实与风险点\",\"目标客群画像\",\"渠道与沟通场景\",\"禁止或敏感表述要求\"]")
OUTPUT_SECTIONS = json.loads("[\"核心话术\",\"客群版本\",\"异议应答\",\"不可说清单\",\"升级处理提示\"]")
