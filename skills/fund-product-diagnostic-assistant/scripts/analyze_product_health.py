...
TASK_NAME = "基金产品体检助手"
TASK_SUMMARY = "对基金产品的业绩、风险、规模、持有人结构、风格稳定性和渠道反馈做综合体检。"
REQUIRED_INPUTS = json.loads("[\"产品基础信息与定位\",\"净值、回撤、波动或收益数据\",\"规模、份额、申赎和持有人结构\",\"同类或基准对照数据\"]")
OUTPUT_SECTIONS = json.loads("[\"体检结论摘要\",\"核心指标诊断\",\"主要问题与原因\",\"风险提示\",\"改进建议与待补充信息\"]")
