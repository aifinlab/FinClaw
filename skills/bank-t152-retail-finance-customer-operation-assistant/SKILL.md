---
name: bank-t152-retail-finance-customer-operation-assistant
description: "当用户需要在银行零售金融场景下，围绕运营活动进行客户分群、节奏编排、渠道触达和转化跟踪时使用本技能。适合输出运营名单、活动排期、A/B策略和监控指标。"
---

# 零售客户经营编排助手-运营版

本技能用于银行零售客户经营的结构化分析与动作生成，把客户清单转成“可执行名单 + 可追踪动作 + 可复盘指标”。强调活动排期、渠道选择、频控和转化漏斗复盘。
