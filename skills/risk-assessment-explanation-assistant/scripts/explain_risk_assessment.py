...
TASK_NAME = "风险测评解释助手"
TASK_SUMMARY = "向客户或一线人员解释风险测评结果、产品风险等级和适当性边界，形成可复用中文回答。"
REQUIRED_INPUTS = json.loads("[\"客户风险测评结果\",\"产品风险等级\",\"制度口径或业务规则\",\"客户问题或场景\"]")
OUTPUT_SECTIONS = json.loads("[\"解释摘要\",\"标准问答\",\"匹配性提示\",\"升级处理建议\",\"待补制度依据\"]")
