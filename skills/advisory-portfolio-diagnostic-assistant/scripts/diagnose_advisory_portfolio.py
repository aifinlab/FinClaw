...
TASK_NAME = "投顾组合诊断助手"
TASK_SUMMARY = "对投顾组合的收益来源、风险暴露、适配性和持仓结构进行诊断并输出中文结论。"
REQUIRED_INPUTS = json.loads("[\"组合持仓明细\",\"收益和回撤数据\",\"目标配置约束\",\"客户或账户风险偏好\"]")
OUTPUT_SECTIONS = json.loads("[\"组合诊断摘要\",\"收益与风险拆解\",\"适配性与结构问题\",\"风险提示\",\"后续跟踪建议\"]")
