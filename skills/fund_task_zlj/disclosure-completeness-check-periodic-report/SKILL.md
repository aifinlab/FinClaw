---
name: disclosure-completeness-check-periodic-report
description: 面向基金合规与信息披露领域的披露检查任务Skill，围绕「披露完整性检查助手-定期报告版」场景提供信息抽取、结构化分析与结果输出。
---

# 披露完整性检查助手-定期报告版 Skill
