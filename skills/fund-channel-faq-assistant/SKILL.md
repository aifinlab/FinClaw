---
name: fund-channel-faq-assistant
description: |
  当用户需要在基金场景中完成渠道FAQ助手相关任务时使用本技能，适用于FAQ问答及相关分析、生成、审阅请求。
  用户提到「渠道FAQ」「基金FAQ」「常见问题」或需要输出结构化中文结论、模板和配套脚本时，应优先触发。
---

# 技能说明

本技能用于支持基金业务中的FAQ问答工作，重点解决「把基金产品、交易规则、费用和流程问题整理成渠道可复用的 FAQ 知识卡片。」这类任务。输出默认使用中文，要求结构清楚、证据边界明确，并能被投研、产品、销售、投顾或合规团队直接复用。
...
- assets/templates/channel_faq_template.md：默认输出模板。
- assets/templates/data_request_template.md：缺失材料补充模板。

# 可调用脚本

- scripts/build_channel_faq.py
- scripts/render_channel_faq.py
