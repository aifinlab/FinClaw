...
TASK_NAME = "路演问答助手"
TASK_SUMMARY = "为基金路演、渠道培训和客户说明会生成高频问答、追问准备和敏感问题边界说明。"
REQUIRED_INPUTS = json.loads("[\"产品资料与经理资料\",\"路演主题和目标客群\",\"历史高频问题\",\"合规限制\"]")
OUTPUT_SECTIONS = json.loads("[\"路演Q&A清单\",\"重点追问与回答边界\",\"敏感问题升级建议\",\"补充材料清单\",\"主持串联提示\"]")
