...
TASK_NAME = "客户陪伴内容助手"
TASK_SUMMARY = "围绕客户持有基金的市场表现、回撤波动和长期配置逻辑，生成中文陪伴内容草稿。"
REQUIRED_INPUTS = json.loads("[\"持有产品和市场表现\",\"客户画像与风险等级\",\"近期波动原因\",\"希望触达的场景\"]")
OUTPUT_SECTIONS = json.loads("[\"陪伴内容摘要\",\"事实解释\",\"情绪安抚表述\",\"后续关注点\",\"敏感边界提示\"]")
