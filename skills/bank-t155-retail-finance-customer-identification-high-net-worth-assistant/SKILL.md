---
name: bank-t155-retail-finance-customer-identification-high-net-worth-assistant
description: "当用户需要在银行零售金融场景下，围绕高净值客户识别进行候选筛选、潜力评估、服务分层和资源分配时使用本技能。适合输出高净值候选名单、服务优先级、跟进建议和风险提示。"
---
