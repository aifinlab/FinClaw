...
TASK_NAME = "基金经理画像助手"
TASK_SUMMARY = "对基金经理的履历、投资框架、风格稳定性、回撤特征和沟通标签做结构化画像。"
REQUIRED_INPUTS = json.loads("[\"经理履历与任职信息\",\"代表产品和任职区间表现\",\"投资框架和行业偏好资料\",\"回撤、波动和风格稳定性信息\"]")
OUTPUT_SECTIONS = json.loads("[\"经理画像摘要\",\"履历与代表作\",\"风格与能力圈\",\"风险与短板\",\"适用场景与待补充信息\"]")
