...
TASK_NAME = "新产品材料生成助手"
TASK_SUMMARY = "根据新基金产品方案、定位和渠道需求生成中文材料草稿，并保留合规复核边界。"
REQUIRED_INPUTS = json.loads("[\"产品设计方案与定位\",\"策略亮点与风险点\",\"目标渠道与目标客群\",\"已有披露材料或制度要求\"]")
OUTPUT_SECTIONS = json.loads("[\"材料摘要\",\"核心卖点\",\"风险揭示点\",\"渠道沟通版本建议\",\"待补材料清单\"]")
