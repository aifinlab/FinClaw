---
name: fund-announcement-interpretation-unitholder-meeting
description: 面向基金投研分析领域的公告解读任务Skill，围绕「基金公告解读助手-持有人大会版」场景提供信息抽取、结构化分析与结果输出。
---

# 基金公告解读助手-持有人大会版 Skill
