...
TASK_NAME = "生命周期监测助手"
TASK_SUMMARY = "根据规模、申赎、业绩、渠道热度和客户反馈判断基金产品所处生命周期并输出监测提示。"
REQUIRED_INPUTS = json.loads("[\"规模、份额与申赎数据\",\"净值和回撤表现\",\"渠道热度或销售数据\",\"阶段目标与运营策略\"]")
OUTPUT_SECTIONS = json.loads("[\"生命周期阶段判断\",\"关键监测指标\",\"异常信号\",\"动作建议\",\"待补充数据\"]")
