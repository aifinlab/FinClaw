...
TASK_SUMMARY = "对基金宣传材料、路演稿、海报和渠道文案做合规风险扫描并输出修订建议。"
REQUIRED_INPUTS = json.loads("[\"原始材料文本\",\"适用渠道与客群\",\"制度或合规要求\",\"版本信息\"]")
OUTPUT_SECTIONS = json.loads("[\"审查摘要\",\"高风险问题清单\",\"修订建议\",\"升级事项\",\"待核验制度依据\"]")
