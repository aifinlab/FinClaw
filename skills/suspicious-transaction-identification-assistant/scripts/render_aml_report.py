...
def render_report(result: dict[str, Any]) -> str:
    ...
    lines.append(f"- 风险等级：{summary.get('risk_level_after_calibration', summary.get('risk_level', '未知'))}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output", default="aml_report.md", help="输出 Markdown 文件")
