...
TASK_NAME = "产品定位分析助手"
TASK_SUMMARY = "围绕产品策略、客群、渠道、同类差异和产品线分工，对基金产品定位进行分析。"
REQUIRED_INPUTS = json.loads("[\"产品合同与募集材料\",\"策略与基准信息\",\"目标客群和渠道定位\",\"同类产品对照\"]")
OUTPUT_SECTIONS = json.loads("[\"定位摘要\",\"目标客群与渠道\",\"差异化卖点\",\"冲突与风险\",\"优化建议\"]")
