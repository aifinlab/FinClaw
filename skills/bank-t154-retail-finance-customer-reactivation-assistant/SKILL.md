---
name: bank-t154-retail-finance-customer-reactivation-assistant
description: "当用户需要在银行零售金融场景下，围绕沉默客户进行流失风险评估、唤醒优先级排序和挽回动作设计时使用本技能。适合输出唤醒名单、分层触达策略、服务修复建议和复盘标准。"
---
