...
TASK_NAME = "基金公告解读助手"
TASK_SUMMARY = "对基金公告、临时公告、分红公告、经理变更公告等内容进行结构化解读并提炼影响点。"
REQUIRED_INPUTS = json.loads("[\"原始公告全文\",\"产品基础信息\",\"涉及事项的时间线\",\"历史类似事件或存量规则\"]")
OUTPUT_SECTIONS = json.loads("[\"公告摘要\",\"关键变化点\",\"潜在影响分析\",\"对内对外沟通建议\",\"待核验事项\"]")
