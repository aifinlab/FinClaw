...
[![Skills](https://img.shields.io/badge/Skills-1023%2B-blueviolet.svg)](#-skills-分类概览)
[![Free](https://img.shields.io/badge/免费-0元-brightgreen.svg)]()

> **开箱即用的金融数据投研神器** —— **1023+ 金融 Skills，6 只金融龙虾**，覆盖 **银行、券商、保险、基金、期货、信托**全品类，赋能全赛道金融人！**无需 API Key，一键上手！**
...
```
用户请求 → cn-stock-data（统一入口）→ 智能路由 → 多数据源自动Fallback
```
