...
| 🗄️ **数据源** | 46 | 统一抽象层 + AkShare 29个 + 东财/同花顺/巨潮/FRED/ECB/BOJ |
| 🛡️ **保险** | 21 | 核保/理赔/产品对比/保障分析/营销/合规 |
| 📋 **投研助手** | 15 | 公司研究/行业研究/财报快评/尽调/适当性审核 |
| 🏦 **银行** | 5 | 经营分析/渠道交易/客户管理/风控合规/流程编排 |
| 📰 **财经新闻** | 2 | 12+ 源聚合抓取 + 情感分析/影响评估 |
| 🤖 **量化工具** | 8 | 回测/因子/AI选股/组合优化/事件研究/可视化 |
| 🔥 **舆情** | 4 | 东财股吧/微博/雪球/全球宏观 |
| 🧰 **通用工具** | 17 | PDF/Word/Excel/PPT/前端/MCP/API |
| 📎 **其他** | 9 | AI选股/大宗商品链/FastGPT 等 |
